...
import { GongformspecificModule } from 'gongformspecific'
import { GongformdatamodelModule } from 'gongformdatamodel'
import { GongstructSelectionService } from 'gongform'
...
@NgModule({
  ...
  imports: [
    ...
    GongformModule,
    GongformspecificModule,
    GongformdatamodelModule,
  ],
  providers: [
