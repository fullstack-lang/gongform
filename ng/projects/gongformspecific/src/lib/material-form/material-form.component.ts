...
import { MaterialTableComponent } from '../../../../../../vendor/github.com/fullstack-lang/gongtable/ng/projects/gongtablespecific/src/lib/material-table/material-table.component'

@Component({
  selector: 'lib-material-form-tmp',
...
export class MaterialFormComponent implements OnInit {
  ...
  public gongtableFrontRepo?: gongform.FrontRepo

  // for selection
  selectedFormGroup: gongform.FormGroupDB | undefined = undefined;
  ...
  constructor(
    ...
    private gongtableFrontRepoService: gongform.FrontRepoService,
    private gongtableCommitNbFromBackService: gongform.CommitNbFromBackService,
    private formBuilder: FormBuilder,

    private formFieldStringService: gongform.FormFieldStringService,
    private formFieldIntService: gongform.FormFieldIntService,
    private formFieldFloat64Service: gongform.FormFieldFloat64Service,
    private formFieldDateService: gongform.FormFieldDateService,
    private formFieldTimeService: gongform.FormFieldTimeService,
    private formFieldDateTimeService: gongform.FormFieldDateTimeService,
    private checkBoxService: gongform.CheckBoxService,
    private formFieldSelectService: gongform.FormFieldSelectService,
    private formEditAssocButtonService: gongform.FormEditAssocButtonService,
    private formSortAssocButtonService: gongform.FormSortAssocButtonService,

    private formGroupService: gongform.FormGroupService,
  ) {
  ...
  refresh(): void {
    ...
    this.gongtableFrontRepoService.pull(this.DataStack).subscribe(
      gongtablesFrontRepo => {
        ...
        for (let form of this.gongtableFrontRepo.getArray<gongform.FormGroupDB>(gongform.FormGroupDB.GONGSTRUCT_NAME)) {
  ...
  getDynamicStyles(formField: gongform.FormFieldDB): { [key: string]: any } {
