...
import (
	...
	"github.com/fullstack-lang/gongform/go/fullstack"
	"github.com/fullstack-lang/gongform/go/models"
	"github.com/fullstack-lang/gongform/go/orm"
	"github.com/fullstack-lang/gongform/go/probe"
...
func NewStack(
	...
	if withProbe {
		stack.Probe = probe.NewProbe(r, gongform_go.GoModelsDir, gongform_go.GoDiagramsDir,
